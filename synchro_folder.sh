...
sshfs cargo.ciment:/bettik/PROJECTS/${PROJECT_NAME}/godeta/checkpoints/NightToday/ "${PROJECT_DIR}/checkpoints/download/weights"
sshfs cargo.ciment:/silenus/PROJECTS/pr-remote-sensing-1a/godeta/training_visuals/ "${PROJECT_DIR}/checkpoints/download/visuals"
#sshfs cargo.ciment:/silenus/PROJECTS/${PROJECT_NAME}/godeta/datasets/ "${PROJECT_DIR}/checkpoints/download/datasets"